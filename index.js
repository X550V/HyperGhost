...
client.on("ready", () => {
    ...
    let statuses = [
        `h!help |🌏 Berada ${client.guilds.cache.size} Server`,
        `h!help |👥 Dengan ${client.users.cache.size} Users`,
        `h!help |📞 Online ${client.channels.cache.size} Channels`,
        `h!help |💻 Created By TheBlueRose`
    ];
    ...
    client.on("guildMemberAdd", async(member) => {
        ...
        let data = await canva.welcome(member, { link: "https://i.imgur.com/2tJRiwg.jpg", blur: false })
